...
if not Rails.env.production? 
  #Tutees have 6 digits in their SID
	...
	Request.create!(:id=>"4",:tutee_id=>"2",:course_id=>"2",:meeting_length=>60,:subject=>"seeded request tutee 1", :created_at=>"2021-04-01 12:58:46 -0700", :updated_at=>"2021-04-01 12:58:45 -0700")
