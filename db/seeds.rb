...
if not Rails.env.production?
  ...
  Meeting.create(:tutor_id=>"2", :request_id=>"1", is_done: true)
  ...
  Meeting.create(:tutor_id=>"2", :request_id=>"2", is_done: true)
  ...
  Meeting.create(:tutor_id=>"2", :request_id=>"3", is_done: true)
  ...
  Meeting.create(:tutor_id=>"1", :request_id=>"4", is_done: true)
  ...
  Meeting.create(:tutor_id=>"2", :request_id=>"6")
end
