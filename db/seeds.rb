...
QuestionTemplate.create!(:prompt=>"How many hours of tutoring did you receive?", :is_optional=>false, :question_type=>"text", :order=>1, :is_active=>true, :is_admin_only=>false) #is this text? do we need a "number" category?
QuestionTemplate.create!(:prompt=>"What did you like about how your tutor covered the material?", :is_optional=>false, :question_type=>"text", :order=>2, :is_active=>true, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"What is the best thing that your tutor did?", :is_optional=>false, :question_type=>"text", :order=>3, :is_active=>true, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"What is something your tutor could work to improve?", :is_optional=>false, :question_type=>"text", :order=>4, :is_active=>true, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"How knowledgeable was your tutor?", :is_optional=>false, :question_type=>"scale", :order=>5, :is_active=>true, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"How supportive was your tutor?", :is_optional=>false, :question_type=>"scale", :order=>6, :is_active=>true, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"How clear were your tutor's explanations?", :is_optional=>false, :question_type=>"scale", :order=>7, :is_active=>false, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"How was the pacing of the appointment?", :is_optional=>false, :question_type=>"scale", :order=>8, :is_active=>false, :is_admin_only=>false)
QuestionTemplate.create!(:prompt=>"Any other concerns?", :is_optional=>true, :question_type=>"text", :order=>9, :is_active=>true, :is_admin_only=>true)
