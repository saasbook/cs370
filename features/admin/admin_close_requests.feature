...
Feature:
  ...
  Scenario: Unmatched Requests are Closed
    Given I log in as "Tutee" "Default Open"
    Given I am on "Default Open's" tutee page
  ...
  Scenario: Matched Requests are not closed
    Given I log in as "Tutee" "Default Matched"
    Given I am on "Default Matched's" tutee page
    When I press link "Request"
