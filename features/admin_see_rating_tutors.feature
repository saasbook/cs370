Feature: See Tutor Rating
  ...
  Background: There exists these info
    ...
    Given "thu" has a meeting with tutor "ana" meeting id "1" request with tutuee id "1" course name "CS61A" and evaluation status "Complete" knowledge "5" helpful "5" clarity "5" took place "true"
